...
<body data-spy="scroll" data-target=".navbar" data-offset="10">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand heading" href="#">GlobeGlider</a>
    	...
    	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  			<div class="carousel-inner">
    			<div class="carousel-item active">
      				<img class="d-block w-100" src="images/slideshow/humayun-tomb.png" alt="Andaman and Nicobar">
    			</div>
	    		<div class="carousel-item">
	      			<img class="d-block w-100" src="images/slideshow/img1.png" alt="Taj Mahal">
	    		</div>
	    		<div class="carousel-item">
	      			<img class="d-block w-100" src="images/slideshow/img2.png" alt="Munnar">
	    		</div>
	    		<div class="carousel-item">
	      			<img class="d-block w-100" src="images/slideshow/img3.png" alt="Chadar Trek">
	    		</div>
	    		<div class="carousel-item">
	      			<img class="d-block w-100" src="images/slideshow/india_gate.png" alt="Udaipur">
	    		</div>
	    		<div class="carousel-item">
	      			<img class="d-block w-100" src="images/slideshow/img4.png" alt="Treks">
	    		</div>
	    		<div class="carousel-item">
	      			<img class="d-block w-100" src="images/slideshow/golden-temple.png" alt="Sports">
	    		</div>
	    		<div class="carousel-item">
	      			<img class="d-block w-100" src="images/slideshow/tajmahal.png" alt="Srinagar">
...
<?php
  ...
  ?>
    	...
    	<div class="container-fluid text-center text-md-left">
      		<div class="row">
        		<div class="col-md-6 mt-md-0 mt-3">
          			...
          			<p class="footerText"><i class="fa fa-envelope icon" aria-hidden="true"></i> help@GlobeGlider.com</p>
    	...
    	<div class="footer-copyright text-center py-3 madeby">
    		Made by<font style="color: #ffc312;"> Abhay Saini, Samaira Singh, Aryan Rajput & Yash Singhal</font>
    	</div>
  	</footer>
